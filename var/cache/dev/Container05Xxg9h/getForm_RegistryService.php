...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\AccountsManagersType' => ['privates', 'App\\Form\\AccountsManagersType', 'getAccountsManagersTypeService', true],
            'App\\Form\\CertificatesType' => ['privates', 'App\\Form\\CertificatesType', 'getCertificatesTypeService', true],
            'App\\Form\\ClientsType' => ['privates', 'App\\Form\\ClientsType', 'getClientsTypeService', true],
            'App\\Form\\DomainsType' => ['privates', 'App\\Form\\DomainsType', 'getDomainsTypeService', true],
            'App\\Form\\HostsType' => ['privates', 'App\\Form\\HostsType', 'getHostsTypeService', true],
            'App\\Form\\ProjectsType' => ['privates', 'App\\Form\\ProjectsType', 'getProjectsTypeService', true],
            'App\\Form\\ServersType' => ['privates', 'App\\Form\\ServersType', 'getServersTypeService', true],
            ...
            'App\\Form\\AccountsManagersType' => '?',
            'App\\Form\\CertificatesType' => '?',
            'App\\Form\\ClientsType' => '?',
            'App\\Form\\DomainsType' => '?',
            'App\\Form\\HostsType' => '?',
            'App\\Form\\ProjectsType' => '?',
            'App\\Form\\ServersType' => '?',
            'App\\Form\\UserType' => '?',
